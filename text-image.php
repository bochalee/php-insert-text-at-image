<?php
$a = $_POST['text'];
$b = $_POST['font_position'];
$c = $_POST['image'];
$d = $_POST['font_size'];
$e = $_POST['font_color']; 
$f = $_POST['font_name'];
$g = $_POST['author']; 
$img = "./code.php?a=".$a."&b=".$b."&c=".$c."&d=".$d."&e=".$e."&f=".$f."&g=".$g;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="container theme-showcase" role="main" style="margin-top:50px">
	 ...
	 <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Your Image is Ready</h3>
            </div>
	 ...
	 <div class="col-sm-4">
	 <div class="panel-body">
             <p>To download the image. Right Click the mouse over image and save it.</p>
